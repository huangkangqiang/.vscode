...
class QueryRunner {
    ...
    runQuery(selection) {
        ...
        return this._client.sendRequest(queryExecute_1.QueryExecuteRequest.type, queryDetails).then(result => {
    ...
    handleBatchComplete(result) {
        ...
        this._batchSets[batch.id] = batch;
        this._totalElapsedMilliseconds += (Utils.parseTimeString(batch.executionElapsed) || 0);
