...
class ConnectionProfile extends connectionCredentials_1.ConnectionCredentials {
    ...
    static createProfile(prompter, defaultProfileValues) {
        ...
        let questions = connectionCredentials_1.ConnectionCredentials.getRequiredCredentialValuesQuestions(profile, true, true, defaultProfileValues);
        ...
        questions.push({
            ...
            shouldPrompt: (answers) => connectionCredentials_1.ConnectionCredentials.isPasswordBasedCredential(profile),
