...
class ConnectionStore {
     ...
     */
    getPickListItems() {
        let pickListItems = this.loadAllConnections();
        pickListItems.push({
    ...
    addSavedPassword(credentialsItem) {
        ...
        return new Promise((resolve, reject) => {
            ...
            else if (connectionCredentials_1.ConnectionCredentials.isPasswordBasedCredential(credentialsItem.connectionCreds)
