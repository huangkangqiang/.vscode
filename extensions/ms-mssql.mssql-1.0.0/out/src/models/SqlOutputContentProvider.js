...
class SqlOutputContentProvider {
    ...
    displayResultPane(resultsUri, paneTitle) {
        ...
        if (!this.doesResultPaneExist(resultsUri)) {
            ...
            vscode.commands.executeCommand('vscode.previewHtml', resultsUri, resultPaneColumn, paneTitle).then(() => {
                ...
                let resultPaneTextEditor = this._vscodeWrapper.visibleEditors.find(editor => editor.document.uri.toString() === resultsUri);
     ...
     */
    doesResultPaneExist(resultsUri) {
