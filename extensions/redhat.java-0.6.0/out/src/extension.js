...
function activate(context) {
    vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Window, title: 'Starting Java Language Server' }, p => {
        return new Promise((resolve, reject) => {
            ...
            let serverOptions = javaServerStarter_1.runServer.bind(null, workspacePath, getJavaConfiguration());
