...
function activate(context) {
    ...
    vscode_1.commands.registerCommand('java.show.references', (uri, position, locations) => {
        vscode_1.commands.executeCommand('editor.action.showReferences', vscode_1.Uri.parse(uri), languageClient.protocol2CodeConverter.asPosition(position), locations.map(languageClient.protocol2CodeConverter.asLocation));
    });
    ...
    vscode_1.commands.registerCommand('java.apply.workspaceEdit', (obj) => {
