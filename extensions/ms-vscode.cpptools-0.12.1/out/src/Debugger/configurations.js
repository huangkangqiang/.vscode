...
"type": "${type}",
"request": "launch",
"program": "${"enter program name, for example " + EnsureTokensEscapedInLaunchJsonMacro("workspaceRoot", isInitialConfiguration) + "/" + executable}",
"args": [],
"stopAtEntry": false,
"cwd": \"${EnsureTokensEscapedInLaunchJsonMacro("workspaceRoot", isInitialConfiguration)}\",
"environment": [],
