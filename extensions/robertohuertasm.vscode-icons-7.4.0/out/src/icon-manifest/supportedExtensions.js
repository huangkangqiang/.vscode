...
exports.extensions = {
    ...
    supported: [
        ...
        { icon: 'graphql', extensions: [], languages: [languages_1.languages.graphql], format: models_1.FileFormat.svg },
        ...
        { icon: 'phpunit', extensions: ['phpunit.xml'], filename: true, format: models_1.FileFormat.svg },
        ...
        { icon: 'yarn', extensions: ['yarn.lock', '.yarnrc', '.yarnclean', '.yarn-integrity', '.yarn-metadata.json'], filename: true, format: models_1.FileFormat.svg },
