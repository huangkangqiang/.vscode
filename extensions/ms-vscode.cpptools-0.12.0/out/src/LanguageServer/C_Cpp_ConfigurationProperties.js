...
const IntervalTimerRequest_type = {
    get method() { return "C_Cpp/onIntervalTimer"; }
};
class ConfigurationProperties {
    ...
    parsePropertiesFile() {
        try {
            ...
            let dirty = false;
            for (let i = 0; i < this.configurationJson.configurations.length; i++) {
                if (this.configurationJson.configurations[i].intelliSenseMode === undefined) {
                    this.configurationJson.configurations[i].intelliSenseMode = this.getIntelliSenseModeForPlatform(this.configurationJson.configurations[i].name);
                    dirty = true;
                }
            }
