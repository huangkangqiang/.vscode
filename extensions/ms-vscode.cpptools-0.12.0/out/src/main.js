        ...
        if (!lockExists) {
            ...
            platform_1.PlatformInformation.GetPlatformInformation()
                ...
                if (os.platform() !== 'win32') {
                    ...
                    return fs.rename(path.resolve(util.getDebugAdaptersPath(), 'bin', 'OpenDebugAD7.exe.config'), path.resolve(util.getDebugAdaptersPath(), 'bin', 'OpenDebugAD7.exe.config.unused'));
                }
            })
                .then(() => {
